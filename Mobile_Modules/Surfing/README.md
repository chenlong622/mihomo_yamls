...
### 📝 config.yaml
- **大小**: 19.1 KB
- **链接**: [查看源码](https://github.com/chenlong622/mihomo_yamls/blob/main/Mobile_Modules/Surfing/config.yaml)
...
| 文件名 | 大小 | 链接 |
| :--- | :--- | :--- |
| `config.yaml` | 19.1 KB | [查看](https://github.com/chenlong622/mihomo_yamls/blob/main/Mobile_Modules/Surfing/config.yaml) |